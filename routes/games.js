...
const { findAllGames, createGame, findGameById, updateGame, sendGameUpdated, deleteGame } = require("../middlewares/games");
const { sendAllGames, sendGameCreated, sendGameById, sendGameDeleted } = require("../controllers/games");
